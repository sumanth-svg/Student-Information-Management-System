...
const App = () => {
    ...
    function signin(){
        ...
        setIsProgress(true);
        callApi("POST", apibaseurl + "/signin", signinData, null, signinResponseHandler);
    }
    ...
    function signup(){
        ...
        setIsProgress(true);
        // Only send the required fields (backend doesn't need retypepassword)
        const dataToSend = {
        ...
        callApi("POST", apibaseurl + "/signup", dataToSend, null, signupResponseHandler);
    }
